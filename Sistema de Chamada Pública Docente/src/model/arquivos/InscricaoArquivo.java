...
public class InscricaoArquivo implements IMantemArquivos{

	public InscricaoArquivo() {
		super();
	}
	...
	public void atualizar(String codLinha, String nomeEntidade, String novaLinha, ProcessoSeletivo processo) throws Exception {
